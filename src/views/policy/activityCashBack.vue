<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			<el-table-column prop="policyActivityId" label="活动返现政策ID" width="170" sortable>
			</el-table-column>
			<el-table-column prop="validDay" label="有效时间" width="150" sortable>
			</el-table-column>
			<el-table-column prop="achieveAmount" label="达标金额(元)" width="250" sortable>
			</el-table-column>
		...
		<el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
			<el-form :data="addForm" label-width="120px" ref="addForm">
				<el-form-item label="达标金额" prop="achieveAmount">
		...
		methods: {
			...
			addSubmit() {               	
				this.$confirm('确认提交吗？', '提示', {}).then(() => {
					...
					this.$http.post(this.baseCont.JAVA_API + 'ITY_002',params).then(function(response) {

<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			<el-table-column prop="buyAmount" label="购买金额(元)" width="170" sortable>
			</el-table-column>
			<el-table-column prop="validDay" label="有效时间(天)" width="150" sortable>
			</el-table-column>
			<el-table-column prop="rate" label="费率(%)" width="250" sortable>
			</el-table-column>
			<el-table-column prop="state" label="状态" :formatter="formatState" width="160" sortable>
			</el-table-column>
			<el-table-column prop="cashbackAmount" label="返现金额(元)" width="160" sortable>
			</el-table-column>
		...
		<el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
			<el-form :data="addForm" label-width="120px" ref="addForm">
				<el-form-item label="购买金额" prop="buyAmount">
					<el-input v-model="addForm.buyAmount" auto-complete="off"></el-input>
				</el-form-item>
	...
	export default {
		...
		methods: {
			...
			getUsers() {
                ...
                this.$http.post(this.baseCont.JAVA_API + 'VIP_001',params).then(function(response) {
			...
			addSubmit() {               	
				this.$confirm('确认提交吗？', '提示', {}).then(() => {
					...
					this.$http.post(this.baseCont.JAVA_API + 'VIP_002',params).then(function(response) {

<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="txnAmount" label="VIP金额" :formatter="formatTxnAmount" min-width="180" sortable>
			</el-table-column>
			<el-table-column prop="buyAmount" label="vip类型" :formatter="formatBuyAmount" min-width="180" sortable>
			</el-table-column>
...
<script>
	export default {
		...
		methods: {
		    formatBuyAmount(row, column, cellValue) {
                if(cellValue == "9000"){
	                return '90天';
			...
			getUsers() {
                ...
                this.$http.post(this.baseCont.JAVA_API + 'ORD_002',params).then(function(response) {

<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="txnType" label="交易类型" :formatter="formatTxnType" min-width="180" sortable>
			</el-table-column>
	...
	export default {
		...
		methods: {
			...
			getUsers() {
                ...
                this.$http.post(this.baseCont.JAVA_API + 'ORD_003',params).then(function(response) {
